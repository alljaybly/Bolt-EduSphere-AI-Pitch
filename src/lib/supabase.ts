/**
    ...
    const supabaseUrl = import.meta.env.VITE_SUPABASE_URL || 'https://pdvxuebpqkctsanjdmeh.supabase.co';
    const supabaseAnonKey = import.meta.env.VITE_SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InBkdnh1ZWJwcWtjdHNhbmpkbWVoIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTE2MTQ3MjAsImV4cCI6MjA2NzE5MDcyMH0.yFniZZG-X8sI_UPAhZTCke5TnS3Edd7uUUE7usG1wk8';
